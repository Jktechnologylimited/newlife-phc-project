...
export default async function SchoolEventDetailPage({
  params,
}: {
  params: Promise<{ slug: string }>;
}) {
  ...
  return (
    <div className="mx-auto max-w-5xl px-5 py-12 lg:px-8">
      <Link href="/school/events" className="inline-flex items-center gap-1.5 text-sm text-slate hover:text-ink">
      ...
      <div className="mt-6 grid gap-10 lg:grid-cols-[1.1fr_1fr]">
        <div>
          <p className="text-sm font-medium text-school-deep">{event.date}</p>
